...
//        ЗДРАВСТВУЙТЕ, ИВАН! НА СЛУЧАЙ ЕСЛИ ВЫ ВИДИТЕ ЭТО СООБЩЕНИЕ, Я НЕ УСПЕЛ ВОВРЕМЯ ПОДКЛЮЧИТЬ SPRING BOOT К ПРИЛОЖЕНИЮ. ОБЕЩАЮ ДОДЕЛАТЬ
//        ЭТО ЗАДАНИЕ В БЛИЖАЙШЕЕ ВРЕМЯ. ДУМАЮ МНЕ ПОНАДОБИТСЯ ОДИН ДЕНЬ. ВСЁ ОСТАЛЬНОЕ ВРОДЕ РАБОТАЕТ.
